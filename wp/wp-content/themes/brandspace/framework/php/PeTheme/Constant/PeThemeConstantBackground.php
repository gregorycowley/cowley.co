	...
	public function __construct() {
			...
			array(
				  ...
				  array(
						...
						array(
							  ...
							  "type"=>"RadioUI",
							  "description" => __pe("This option controls the backgrounds type.<br/><span><strong>Default</strong> uses global setting (defined in theme options).<br/></span><strong>Color</strong> means the image will be shown in the background in full color.<br/><strong>Black & White</strong> means it will be shown in greyscale and <br/><strong>None</strong> disables the custom background component."),
						...
						array(
							  ...
							  "default"=> PE_THEME_URL."/img/content/pat.png"
							  )
						)
				  );
		...
		foreach ($this->metabox["content"] as $key => $value) {
			...
			if ($key == "type") {
				...
				$value["default"] = "none";
				$value["description"] = preg_replace("/<span>.*<\/span>/","",$value["description"]);
			} 
