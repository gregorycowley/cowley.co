...
class PeThemeImage {
	...
	public function image_resize($file,$width,$height,$crop) {
		if (function_exists("wp_get_image_editor")) {
			...
			// WP 3.4 and below
			return image_resize($file,$width,$height,$crop);
		}
	}
	...
	public function resizedImg($url,$w,$h = null) {
		...
		return apply_filters("pe_theme_resized_img","<img width=\"$w\" height=\"$h\" src=\"$url\"/>",$url,$w,$h);
	}
